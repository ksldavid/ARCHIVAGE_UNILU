...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (isValidUser) {
        // Dans une vraie app, on vérifierait aussi le mot de passe
        router.push('/')
      } else {
  ...
  // --- Animation de particules (Portage de index.js) ---
  useEffect(() => {
    ...
    let particles: any[] = []
    const formingCount = 400 // Réduit pour Next.js performance
