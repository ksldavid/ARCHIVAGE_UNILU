                        ...
                        <tr key={idx} style={{ borderBottom: '1px solid #f8fafc' }}>
                          ...
                          <td style={{ padding: '14px 0', textAlign: 'right' }}>
                            <span style={{ 
                              ...
                              background: (['AA', 'ADM', 'V', 'COMP', 'S', 'A', 'ADS'].some(code => student.decision.toUpperCase().includes(code)) || student.decision.startsWith('R')) ? '#dcfce7' : (student.decision.includes('AJ') || student.decision.includes('DEF') || student.decision.includes('NV')) ? '#fee2e2' : '#fef9c3',
                              color: (['AA', 'ADM', 'V', 'COMP', 'S', 'A', 'ADS'].some(code => student.decision.toUpperCase().includes(code)) || student.decision.startsWith('R')) ? '#166534' : (student.decision.includes('AJ') || student.decision.includes('DEF') || student.decision.includes('NV')) ? '#991b1b' : '#854d0e'
                            }}>
                              {student.decision}
                            </span>
                          </td>
